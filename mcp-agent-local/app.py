...
# Force l'installation de mistralai et mcp dans l'environnement virtuel Streamlit
try:
    import mistralai
    import mcp
except ImportError:
    subprocess.check_call([sys.executable, "-m", "pip", "install", "mistralai", "mcp"])
...
# 3. Gestion des échanges avec Mistral et MCP
